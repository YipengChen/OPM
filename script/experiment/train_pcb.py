...
class Config(object):
  def __init__(self):
    ...
    self.epochs_per_test = args.epochs_per_test
...
def main():
  ...
  for ep in range(start_ep, cfg.total_epochs):
    ...
    while not epoch_done:
      ...
      if cfg.num_layers >=1:
          loss1 = criterion(logits_list[0], labels_var)
          loss2 = criterion(logits_list[1], labels_var)
          loss3 = criterion(logits_list[2], labels_var)
          loss4 = criterion(logits_list[3], labels_var)
          loss5 = criterion(logits_list[4], labels_var)
          loss6 = criterion(logits_list[5], labels_var)
          if cfg.num_layers >=2:
              loss12 = criterion(logits_list[6], labels_var)
              loss23 = criterion(logits_list[7], labels_var)
              loss34 = criterion(logits_list[8], labels_var)
              loss45 = criterion(logits_list[9], labels_var)
              loss56 = criterion(logits_list[10], labels_var)
              if cfg.num_layers >=3:
                  loss123 = criterion(logits_list[11], labels_var)
      ...
      weight_id = 1
      weight_metric = cfg.weight_metric_loss
      loss = weight_id*id_loss + weight_metric*metric_loss
